...
urlpatterns = [
    ...
    path('review-request/<int:review_id>/decline/', views.decline_review, name='decline_review'),
    ...
    path('submission/<int:submission_id>/versions/', views.submission_versions, name='submission_versions'),
]